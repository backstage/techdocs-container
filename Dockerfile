...
ARG MKDOCS_KROKI_PLUGIN_VERSION=0.6.1
RUN pip install --upgrade pip && pip install mkdocs-techdocs-core==${MKDOCS_VERSION} mkdoc-kroki-plugin==${MKDOCS_KROKI_PLUGIN_VERSION}
